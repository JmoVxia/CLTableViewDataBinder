...
//MARK: - JmoVxia---枚举
extension CLSectionHeadView {
}

class CLSectionHeadView: UITableViewHeaderFooterView {
...
private extension CLSectionHeadView {
    func setupUI() {
...
extension CLSectionHeadView: CLSectionHeaderFooterProtocol {
    func setItem(_ item: CLSectionItem, section: Int) {
        leftLabel.attributedText = item.headTitle
